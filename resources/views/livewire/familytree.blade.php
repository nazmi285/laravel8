                    ...
                    <li>
                        <div class="position-relative">
                            ...
                            <span class="{{$family->gender}}">
                                <i class="fas fa-3x fa-user-circle" data-bs-toggle="modal" data-bs-target="#showDetailMemberModal" wire:click="show({{$family->id}})"></i>
                                <p>{{$family->name}}</p>
                            </span>
                            @if($family->partner)
                                <span class="{{$family->partner->gender}}" data-bs-toggle="modal" data-bs-target="#showDetailMemberModal" wire:click="show({{$family->partner->id}})">
