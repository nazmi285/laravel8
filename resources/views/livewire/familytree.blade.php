<div>
    ...
    <div wire:ignore.self class="modal fade p-0 " id="showMemberModal" tabindex="-1" aria-labelledby="showMemberModalLabel" aria-modal="true" role="dialog" >
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12 mb-3">
                            ...
                            <div class="col-12 col-sm-8 col-md-8">
                                <input type="text" class="form-control disabled" maxlength="255" wire:model="upd_name" id="name" >
                            </div>
                        </div>
                        <div class="col-12 col-md-12 mb-3">
                            <label class="col-12 col-sm-4 col-md-4" for="short_name">Short Name</label>
                            <div class="col-12 col-sm-8 col-md-8">
                                <input type="text" class="form-control disabled" maxlength="10" wire:model="upd_short_name" id="short_name" >
                            </div>
                        </div>
                        <div class="col-12 col-md-12 mb-3">
                            <label class="col-12 col-sm-4 col-md-4" for="gender">Gender</label>
                            <div class="col-12 col-sm-8 col-md-8">
                                <select class="form-select" wire:model="upd_gender" id="gender">
                        ...
                        <div class="col-12 col-md-12 mb-3">
                            ...
                            <div class="col-12 col-sm-8 col-md-8">
                                <input type="text" class="form-control disabled" wire:model="upd_birthdate" id="birthdate" >
                            </div>
                        </div>
                        <div class="col-12 col-md-12 mb-3">
