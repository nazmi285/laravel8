<li>
    <div class="position-relative">
        ...
        <span class="{{$sub_family->gender}}">
            <i class="fas fa-3x fa-user-circle" data-bs-toggle="modal" data-bs-target="#showDetailMemberModal" wire:click="show({{$sub_family->id}})"></i>
            <p>{{$sub_family->name}}</p>
        </span>
        @if($sub_family->partner)
            <span class="{{$sub_family->partner->gender}}">
                <i class="fas fa-3x fa-user-circle" data-bs-toggle="modal" data-bs-target="#showDetailMemberModal" wire:click="show({{$sub_family->partner->id}})"></i>
